...
%JN: I tried to clarify "returns high results for all feature types" assuming you
%JN:  meant using them all together, and not using each of them individ.
...
%JN: focus on authorial style rather than the style of a particular piece
...
%JN do next lines add anything?
?? where we use \emph{language} to
%JN describe the style of a
...
central in non-traditional studies of authorship, such as \citeasnoun{Mosteller2008},
...
%
%CC: an (better) alternative is multiplying it by -1, so that higher values indicate representative features.
%
